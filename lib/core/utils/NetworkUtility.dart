...
class NetworkUtility {
  Future<Response?> getData(String url, {Map<String, String>? queryParameters}) async {
    try {
  ...
  Future<Response?> postData({String? url, String? body}) async {
    ...
    try {
      ...
      print('Network Service Error: ${e.toString()}/n StackTrace: $s');
      return null;
    }
  }
  ...
  Future<Response?> putData({String? url, String? body}) async {
    ...
    var uri = Uri.parse(url!);
    try {
      Response response = await http.put(uri, headers: headers, body: body);
      return response;
    } catch (e) {
      print('Network Service Error: ${e.toString()}');
      return null;
  ...
  Future<Response?> postDataWithAuth({String? url, String? body, String? auth}) async {
    var uri = Uri.parse(url!);
